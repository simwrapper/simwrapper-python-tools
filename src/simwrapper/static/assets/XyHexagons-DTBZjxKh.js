import{d as H,m as Q,g as b,n as B,S as v,V as _,C as J}from"./index-D3p5oi12.js";import{d as tt}from"./index-CVL_6l40.js";import{Y as et}from"./index-DFKcNkqO.js";import{H as it}from"./HTTPFileSystem-WNrn1tPJ.js";import{C as st}from"./CollapsiblePanel-CD6PjB1X.js";import{D as nt}from"./DrawingTool-CmcnUtqm.js";import{Z as ot}from"./ZoomButtons-D2uWsuQs.js";import{c as at}from"./index-CGaFlMco.js";import{M as rt}from"./mapbox-overlay-BWTNBTi1.js";import{A as lt}from"./arc-layer-BVLaP1vr.js";import{C as ut}from"./text-layer-Cpq7KRgR.js";import{Q as M,B as ct,X as ht,q as V,Y as gt,x as dt,I as mt,V as ft}from"./layer-GQvgsG1_.js";import{C as pt}from"./column-layer-SKqENiMt.js";import{W as bt}from"./NewXmlFetcher.worker-DSJgeOd2.js";import"./fxp-DjoqftHf.js";import"./geojson-layer-DTh83Hy1.js";import"./path-layer-BllYebBs.js";function vt(s){return new Worker("/assets/CsvGzipParser.worker-CmRyigJZ.js",{name:s?.name})}function yt({pointCount:s,getBinId:t}){const e=new Map;for(let i=0;i<s;i++){const n=t(i);if(n===null)continue;let o=e.get(String(n));o?o.points.push(i):(o={id:n,index:e.size,points:[i]},e.set(String(n),o))}return Array.from(e.values())}function xt({bins:s,dimensions:t,target:e}){const i=s.length*t;(!e||e.length<i)&&(e=new Float32Array(i));for(let n=0;n<s.length;n++){const{id:o}=s[n];Array.isArray(o)?e.set(o,n*t):e[n]=o}return e}const Ct=s=>s.length,E=(s,t)=>{let e=0;for(const i of s)e+=t(i);return e},St=(s,t)=>s.length===0?NaN:E(s,t)/s.length,wt=(s,t)=>{let e=1/0;for(const i of s){const n=t(i);n<e&&(e=n)}return e},Mt=(s,t)=>{let e=-1/0;for(const i of s){const n=t(i);n>e&&(e=n)}return e},At={COUNT:Ct,SUM:E,MEAN:St,MIN:wt,MAX:Mt};function It({bins:s,getValue:t,operation:e,target:i}){(!i||i.length<s.length)&&(i=new Float32Array(s.length));let n=1/0,o=-1/0;for(let a=0;a<s.length;a++){const{points:r}=s[a];i[a]=e(r,t),i[a]<n&&(n=i[a]),i[a]>o&&(o=i[a])}return{value:i,domain:[n,o]}}function D(s,t,e){const i={};for(const o of s.sources||[]){const a=t[o];if(a)i[o]=_t(a);else throw new Error(`Cannot find attribute ${o}`)}const n={};return o=>{for(const a in i)n[a]=i[a](o);return s.getValue(n,o,e)}}function _t(s){const t=s.value,{offset:e=0,stride:i,size:n}=s.getAccessor(),o=t.BYTES_PER_ELEMENT,a=e/o,r=i?i/o:n;if(n===1)return s.isConstant?()=>t[0]:c=>{const u=a+r*c;return t[u]};let l;return s.isConstant?(l=Array.from(t),()=>l):(l=new Array(n),c=>{const u=a+r*c;for(let h=0;h<n;h++)l[h]=t[u+h];return l})}class Dt{constructor(t){this.bins=[],this.binIds=null,this.results=[],this.dimensions=t.dimensions,this.channelCount=t.getValue.length,this.props={...t,binOptions:{},pointCount:0,operations:[],customOperations:[],attributes:{}},this.needsUpdate=!0,this.setProps(t)}destroy(){}get binCount(){return this.bins.length}setProps(t){const e=this.props;if(t.binOptions&&(M(t.binOptions,e.binOptions,2)||this.setNeedsUpdate()),t.operations)for(let i=0;i<this.channelCount;i++)t.operations[i]!==e.operations[i]&&this.setNeedsUpdate(i);if(t.customOperations)for(let i=0;i<this.channelCount;i++)!!t.customOperations[i]!=!!e.customOperations[i]&&this.setNeedsUpdate(i);t.pointCount!==void 0&&t.pointCount!==e.pointCount&&this.setNeedsUpdate(),t.attributes&&(t.attributes={...e.attributes,...t.attributes}),Object.assign(this.props,t)}setNeedsUpdate(t){t===void 0?this.needsUpdate=!0:this.needsUpdate!==!0&&(this.needsUpdate=this.needsUpdate||[],this.needsUpdate[t]=!0)}update(){if(this.needsUpdate===!0){this.bins=yt({pointCount:this.props.pointCount,getBinId:D(this.props.getBin,this.props.attributes,this.props.binOptions)});const t=xt({bins:this.bins,dimensions:this.dimensions,target:this.binIds?.value});this.binIds={value:t,type:"float32",size:this.dimensions}}for(let t=0;t<this.channelCount;t++)if(this.needsUpdate===!0||this.needsUpdate[t]){const e=this.props.customOperations[t]||At[this.props.operations[t]],{value:i,domain:n}=It({bins:this.bins,getValue:D(this.props.getValue[t],this.props.attributes,void 0),operation:e,target:this.results[t]?.value});this.results[t]={value:i,domain:n,type:"float32",size:1},this.props.onUpdate?.({channel:t})}this.needsUpdate=!1}preDraw(){}getBins(){return this.binIds}getResult(t){return this.results[t]}getResultDomain(t){return this.results[t]?.domain??[1/0,-1/0]}getBin(t){const e=this.bins[t];if(!e)return null;const i=new Array(this.channelCount);for(let n=0;n<i.length;n++){const o=this.results[n];i[n]=o?.value[t]}return{id:e.id,value:i,count:e.points.length,pointIndices:e.points}}}function k(s,t,e){return s.createFramebuffer({width:t,height:e,colorAttachments:[s.createTexture({width:t,height:e,format:"rgba32float",mipmaps:!1,sampler:{minFilter:"nearest",magFilter:"nearest"}})]})}const Tt=`uniform binSorterUniforms {
  ivec4 binIdRange;
  ivec2 targetSize;
} binSorter;
`,Pt={name:"binSorter",vs:Tt,uniformTypes:{binIdRange:"vec4<i32>",targetSize:"vec2<i32>"}},F=[1,2,4,8],T=3e38,Ot={SUM:0,MEAN:0,MIN:0,MAX:0,COUNT:0},y=1024;class Nt{constructor(t,e){this.binsFBO=null,this.device=t,this.model=Lt(t,e)}get texture(){return this.binsFBO?this.binsFBO.colorAttachments[0].texture:null}destroy(){this.model.destroy(),this.binsFBO?.colorAttachments[0].texture.destroy(),this.binsFBO?.destroy()}getBinValues(t){if(!this.binsFBO)return null;const e=t%y,i=Math.floor(t/y),n=this.device.readPixelsToArrayWebGL(this.binsFBO,{sourceX:e,sourceY:i,sourceWidth:1,sourceHeight:1}).buffer;return new Float32Array(n)}setDimensions(t,e){const i=y,n=Math.ceil(t/i);this.binsFBO?this.binsFBO.height<n&&this.binsFBO.resize({width:i,height:n}):this.binsFBO=k(this.device,i,n);const o={binIdRange:[e[0][0],e[0][1],e[1]?.[0]||0,e[1]?.[1]||0],targetSize:[this.binsFBO.width,this.binsFBO.height]};this.model.shaderInputs.setProps({binSorter:o})}setModelProps(t){const e=this.model;t.attributes&&e.setAttributes(t.attributes),t.constantAttributes&&e.setConstantAttributes(t.constantAttributes),t.vertexCount!==void 0&&e.setVertexCount(t.vertexCount),t.shaderModuleProps&&e.shaderInputs.setProps(t.shaderModuleProps)}update(t){if(!this.binsFBO)return;const e=zt(t);this._updateBins("SUM",e.SUM+e.MEAN),this._updateBins("MIN",e.MIN),this._updateBins("MAX",e.MAX)}_updateBins(t,e){if(e===0)return;e|=F[3];const i=this.model,n=this.binsFBO,o=t==="MAX"?-T:t==="MIN"?T:0,a=this.device.beginRenderPass({id:`gpu-aggregation-${t}`,framebuffer:n,parameters:{viewport:[0,0,n.width,n.height],colorMask:e},clearColor:[o,o,o,0],clearDepth:!1,clearStencil:!1});i.setParameters({blend:!0,blendColorSrcFactor:"one",blendColorDstFactor:"one",blendAlphaSrcFactor:"one",blendAlphaDstFactor:"one",blendColorOperation:t==="MAX"?"max":t==="MIN"?"min":"add",blendAlphaOperation:"add"}),i.draw(a),a.end()}}function zt(s){const t={...Ot};for(let e=0;e<s.length;e++){const i=s[e];i&&(t[i]+=F[e])}return t}function Lt(s,t){let e=t.vs;t.dimensions===2&&(e+=`
...
`;function z([s,t],e){return[(s+(t&1)/2)*e*C,t*e*S]}const Kt=`
const vec2 DIST = vec2(${C}, ${S});
